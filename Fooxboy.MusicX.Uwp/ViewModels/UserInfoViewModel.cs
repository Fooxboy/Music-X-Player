...
namespace Fooxboy.MusicX.Uwp.ViewModels
{
    public class UserInfoViewModel : ReactiveObject
    {
        ...
        public UserInfoViewModel(IVkApi vkApi)
        {
            ...
            _photo = userObservable.Select(user => user.Photo100.ToString()).ToProperty(this, nameof(Photo), "https://docs.microsoft.com/windows/uwp/contacts-and-calendar/images/shoulder-tap-static-payload.png");
            _fullName = userObservable.Select(user => $"{user.FirstName} {user.LastName}").ToProperty(this, nameof(FullName), "Имя фамилия");
        }
